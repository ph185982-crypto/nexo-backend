...
import { RefreshCw, TrendingUp, Users, Calendar, MessageSquare } from "lucide-react";
...
export default function Resultados({ organizationId, buscas }: {
  organizationId: string;
  buscas: Array<{ id: string; nome: string }>;
}) {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      {/* Header */}
      <div className="flex items-center justify-between gap-3 flex-wrap px-4 md:px-6 py-3 border-b border-border bg-card">
        <div>
          <h2 className="text-base font-semibold text-foreground">Resultados</h2>
          <p className="text-xs text-muted-foreground">Funil de conversão das abordagens</p>
        </div>
        <button
      ...
      {/* Filtros */}
      <div className="flex flex-wrap gap-3 px-4 md:px-6 py-3 border-b border-border bg-card">
        {buscas.length > 0 && (
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-2 py-1.5 text-sm border border-border rounded-lg bg-background text-foreground focus:outline-none focus:border-primary"
            >
      ...
      <div className="flex-1 overflow-auto px-4 md:px-6 py-4 space-y-6">
        {/* KPIs */}
