...
export default function Disparo({ org }: { org: Org }) {
  const [checklistVersao, setChecklistVersao] = useState(0);
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between gap-3 flex-wrap px-4 md:px-6 py-3 border-b border-border bg-card">
        <div className="flex items-center gap-3">
          <div>
            <h2 className="text-base font-semibold text-foreground">Disparo de abordagem</h2>
